package com.bili.diushoujuaner.ui.circlerefresh;
...
public class CircleRefreshLayout extends FrameLayout {
    ...
    private int mHeaderBackColor = 0xff5C84DC;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setAttrs(attrs);
        mPullHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 120, context.getResources().getDisplayMetrics());
        mHeaderHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 80, context.getResources().getDisplayMetrics());
