package com.bili.diushoujuaner.widget.picture;
...
public class PhotoFrescoView extends SimpleDraweeView {
    ...
    public PhotoFrescoView(Context context, GenericDraweeHierarchy hierarchy) {
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(PhotoFrescoView.this);
            }
        }
    };
